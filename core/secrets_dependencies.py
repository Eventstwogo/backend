...
vault_url = " http://vault.driveittech.in/"
vault_token = 'hvs.CpkqAxhf84CzkcQ1aQ4WWfRS'
secret_path = "v1/kv/data/secrets"
...
# vault_url: str, vault_token: str, secret_path: str = "v1/kv/data/secrets"
...
async def fetch_secrets_from_vault() -> Dict[str, str]:
    ...
    Parameters:
        ...
        secret_path (str): The path to the secret in Vault. Defaults to "v1/kv/data/secrets".
            ...
            async with session.get(url, headers=headers) as response:
                ...
                if response.status == 200:
                    ...
                    return {    
                        ...
                        "SENDER_LOGIN": secrets.get("SENDER_LOGIN"),
